...
public class GetCOOCPolarityHindiTwitter {
    public static void main(String[] args)throws IOException
    {
        ...
        File fR2 = new File(rootDirectory+"\\resources\\TwitterCOOC\\twitter_hindi.txt.co_s");
        //PrintWriter writer = new PrintWriter("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\sentimentJavaWords.txt");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\TwitterCOOC\\polarity.txt"), "UTF-8");
