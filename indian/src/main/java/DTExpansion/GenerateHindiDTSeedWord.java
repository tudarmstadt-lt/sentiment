 ...
 */
public class GenerateHindiDTSeedWord {
    ...
    private static int writeToFile(String rootDirectory, LinkedHashMap<String, Double>list)throws IOException
    {
        ...
        for (Map.Entry<String, Double> entry : list.entrySet()) {
            ...
            File fR = new File(rootDirectory+"\\resources\\TwitterDT\\twitterHindiDT.txt");
    ...
    {
        Writer countWriter = new OutputStreamWriter(new FileOutputStream(rootDirectory+"\\resources\\TwitterDT\\abc.txt"), "UTF-8");
        BufferedWriter cfout = new BufferedWriter(countWriter);
    ...
    private static void generateSeedWords(String rootDirectory)throws IOException
    {
        ...
        LinkedHashMap<String, Double> pos = getSentiList(rootDirectory+"\\resources\\Hindi_SentiWordNet\\HN_POS.txt", 1.0);
        LinkedHashMap<String, Double> neg = getSentiList(rootDirectory+"\\resources\\Hindi_SentiWordNet\\HN_NEG.txt", -1.0);
        LinkedHashMap<String, Double> neu = getSentiList(rootDirectory+"\\resources\\Hindi_SentiWordNet\\HN_NEU.txt", 0.0);
        ...
        //end += writeToFile(rootDirectory+"\\resources\\TwitterDT\\twitterHindiDT.txt", neg);
        //end += writeToFile(rootDirectory+"\\resources\\TwitterDT\\twitterHindiDT.txt", neu);
