...
public class GetDTTopWordsPolarityHindi {
    ...
    private void mainFunction(String rootDirectory)throws IOException
    {
        ...
        File fR = new File(rootDirectory+"\\resources\\DTExpansion\\HTTPResults\\valuesDT.txt");
        ...
        Writer polWriter1 = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansion\\HTTPResults\\sortedDT.txt"), "UTF-8");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansion\\HTTPResults\\polarityValuesAll.txt"), "UTF-8");
