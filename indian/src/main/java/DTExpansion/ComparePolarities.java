 ...
 */
public class ComparePolarities {
    public static void main(String[] args)throws IOException
    {
        File fR = new File("D:\\Course\\Semester VII\\Internship\\Hindi Sentiment Analysis Folder 2\\IndianSentCooc\\polarity.txt");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream("D:\\Course\\Semester VII\\Internship\\Hindi Sentiment Analysis Folder 2\\IndianSentCooc\\matching.txt"), "UTF-8");
