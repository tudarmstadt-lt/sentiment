 ...
 */
public class GetDTTopWordsPolarity {
    public static void main(String[] args)throws IOException
    {
        ...
        File fR = new File("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\HTTPResults\\valuesDT.txt");
        ...
        Writer polWriter1 = new OutputStreamWriter(
                new FileOutputStream("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\HTTPResults\\sortedDT.txt"), "UTF-8");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\HTTPResults\\polarityValuesAll.txt"), "UTF-8");
