...
public class SendHTTPRequest {
    ...
    private void mainFunction(String rootDirectory)throws IOException
    {
        ...
        while((line = bf.readLine()) != null)
        {
            ...
            URL oracle = new URL("http://maggie.lt.informatik.tu-darmstadt.de:10080/jobim/ws/api/bengaliBigram/jo/similar/"+url+"?numberOfEntries=100&format=tsv");
            URLConnection yc = oracle.openConnection();
            BufferedReader in = new BufferedReader(new InputStreamReader(yc.getInputStream(), "UTF-8"));
            String inputLine;
            Writer writer = new OutputStreamWriter(
                    new FileOutputStream(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\"+count+".txt"), "UTF-8");
