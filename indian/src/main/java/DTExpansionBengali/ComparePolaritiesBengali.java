 ...
 */
public class ComparePolaritiesBengali {
    String rootDirectory;
    ComparePolaritiesBengali()throws IOException
    {
    ...
    {
        File fR = new File(rootDirectory+"\\resources\\DTExpansionBengali\\IndianSentCooc\\polarity.txt");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DT_COOCBengaliLexicon.txt"), "UTF-8");
