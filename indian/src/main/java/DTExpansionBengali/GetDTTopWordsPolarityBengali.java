 ...
 */
public class GetDTTopWordsPolarityBengali {
    String rootDirectory;
    GetDTTopWordsPolarityBengali()throws IOException
    {
    ...
    private void mainFunction(String rootDirectory)throws IOException
    {
        ...
        File fR = new File(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\valuesDT.txt");
        ...
        Writer polWriter1 = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\sortedDT.txt"), "UTF-8");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\polarityValuesAll.txt"), "UTF-8");
