...
public class GetDTTopCandidateWordsBengali {
    public static void main(String[] args)throws IOException {
        ...
        int num = 1;
        while (num < polarityRoot.size()) {
            System.out.println("Reading file number: " + num);
            File fR = new File(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\" + num + ".txt");
            //PrintWriter writer = new PrintWriter("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\sentimentJavaWords.txt");
        ...
        Writer countWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\valuesDT.txt"), "UTF-8");
        ...
        while (iPos.hasNext()) {
            ...
            URL oracle = new URL("http://maggie.lt.informatik.tu-darmstadt.de:10080/jobim/ws/api/bengaliBigram/jo/count/" + url + "?format=tsv");
