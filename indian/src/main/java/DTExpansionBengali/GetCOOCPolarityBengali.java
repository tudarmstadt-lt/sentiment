 ...
 */
public class GetCOOCPolarityBengali {
    String rootDirectory;
    GetCOOCPolarityBengali()throws IOException
    {
    ...
    {
        File fR = new File(rootDirectory+"\\resources\\DTExpansionBengali\\IndianSentCooc\\bengali_2Mu.tok.words");
        ...
        File fR1 = new File(rootDirectory+"\\resources\\DTExpansionBengali\\HTTPResults\\sortedDT.txt");
        //PrintWriter writer = new PrintWriter("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\sentimentJavaWords.txt");
        ...
        File wordFile = new File(rootDirectory+"\\resources\\sentimentSeedWordsBengali.txt");
        //PrintWriter writer = new PrintWriter("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\sentimentJavaWords.txt");
        ...
        File fR2 = new File(rootDirectory+"\\resources\\DTExpansionBengali\\IndianSentCooc\\bengali_2Mu.tok.co_s");
        //PrintWriter writer = new PrintWriter("D:\\Course\\Semester VII\\Internship\\Results\\Maggie TUD\\sentimentJavaWords.txt");
        ...
        Writer polWriter = new OutputStreamWriter(
                new FileOutputStream(rootDirectory+"\\resources\\DTExpansionBengali\\IndianSentCooc\\polarity.txt"), "UTF-8");
