 ...
 */
public class CorrectEVRestaurants {

    String rootDirectory;

    CorrectEVRestaurants()throws IOException
    {
        rootDirectory = "D:\\Course\\Semester VII\\Internship\\datasetConstruction\\dataset\\";

        removeDuplicates(rootDirectory, "EV_Test_Restaurants.txt", "EV_Test_Restaurants_Without_Duplicates.txt", "Test_Restaurants_Cleansed.txt", "Restaurants_Test_Duplicate_Flag.txt");
        removeDuplicates(rootDirectory, "EV_Train_Restaurants.txt", "EV_Train_Restaurants_Without_Duplicates.txt", "Train_Restaurants_Cleansed.txt", "Restaurants_Train_Duplicate_Flag.txt");
    }
    ...
    {
        CorrectEVRestaurants ob = new CorrectEVRestaurants();
    }
}
