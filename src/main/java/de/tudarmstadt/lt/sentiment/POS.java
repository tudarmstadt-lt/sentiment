...
public class POS {
    ...
    POS(String rootDirectory) {
        ...
        trainingFeature = generateFeature(rootDirectory + "\\dataset\\Train_Restaurants_Contextual_Cleansed.txt", rootDirectory + "\\dataset\\tokenized_Train.txt", rootDirectory + "\\dataset\\raw_POS_Train.txt");
